<template>
  <form @submit="onSubmit" novalidate class="space-y-6 w-full">
    <div class="grid gap-6 md:grid-cols-2">
      ...
      <FormField v-slot="{ componentField, handleChange }" name="public_ticket_require_login">
        <FormItem class="md:col-span-2">
          <SwitchField
            :title="t('admin.general.publicTicketRequireLogin')"
            :description="t('admin.general.publicTicketRequireLogin.description')"
      ...
      <FormField
        ...
        name="public_ticket_require_order_number"
      >
        <FormItem class="md:col-span-2">
          <SwitchField
            :title="t('admin.general.publicTicketRequireOrderNumber')"
            :description="t('admin.general.publicTicketRequireOrderNumber.description')"
            :checked="componentField.modelValue"
            @update:checked="handleChange"
          />
        </FormItem>
...
const form = useForm({
  ...
  initialValues: {
    public_ticket_require_login: true,
    public_ticket_require_order_number: false
  }
})
...
watch(
  ...
  (newValues) => {
    ...
    // Convert business hours id to string
    if (normalizedValues.business_hours_id)
      normalizedValues.business_hours_id = normalizedValues.business_hours_id.toString()
